...
function calcMDRD() {
  ...
  box.innerHTML = `<div class="result-main">${egfr} mL/min/1.73 m²</div><div class="result-sub">Estadio ERC: <span class="pill ${cls}">${cat}</span></div>${egfr < 60 ? '<div class="result-warn">⚠ eGFR &lt;60 — considerar ERC y correlacionar con albuminuria.</div>' : ''}`;
